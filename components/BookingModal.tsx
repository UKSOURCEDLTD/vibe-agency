...
export default function BookingModal({
    isOpen,
    onClose,
    googleCalendarUrl = 'https://calendar.google.com/calendar/appointments/schedules/YOUR_SCHEDULE_ID', // TODO: Replace with your Google Calendar appointment scheduling page URL
}: BookingModalProps) {
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 z-50 bg-deep-charcoal/20 backdrop-blur-sm"
                        onClick={onClose}
                    />
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 pointer-events-none">
                        <div className="min-h-full flex items-center justify-center py-8">
                            <motion.div
                                ...
                                className="relative w-full max-w-6xl bg-white rounded-sm sm:rounded-lg shadow-2xl pointer-events-auto overflow-hidden border border-border-subtle max-h-[95vh] sm:max-h-[90vh] flex flex-col"
